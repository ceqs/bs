package com.complexless.utils
{
	...
	public class BitmapEncoder
	{
		...
		{   
			var bar:ByteArray = encodeByteArray(data);
			var baseEncoder:Base64Encoder = new Base64Encoder();
			baseEncoder.encodeBytes(bar);
		...
		public static function decodeBase64(data:String):BitmapData
		{
			...
			var bitArray:ByteArray = baseDecoder.toByteArray();
			var bmpData:BitmapData = decodeByteArray(bitArray);
			return bmpData;   
		}          
